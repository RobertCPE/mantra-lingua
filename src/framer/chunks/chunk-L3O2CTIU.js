...
var Component = /* @__PURE__ */ React.forwardRef(function(props, ref) {
  ...
  return /* @__PURE__ */ _jsx(SVG, { ...restProps, className: cx("framer-RSmj2", className), layoutId, ref, role: "presentation", style: { "--1m6trwb": qxTvv_EBh, "--21h8s6": ezTt3ayMo, "--pgex8v": lschgej4H, ...style }, viewBox: "0 0 24 24", children: /* @__PURE__ */ _jsx("use", { href }) });
});
var css = [`.framer-RSmj2 { -webkit-mask: ${mask}; aspect-ratio: 1; display: block; mask: ${mask}; width: 24px; }`];
var Icon = withCSS(Component, css, "framer-RSmj2");
